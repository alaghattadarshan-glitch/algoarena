...
const RaceEngine = () => {
  const { array, algorithms, raceStatus, updateMetric, speed, setWinner, finishRace, soundEnabled } = useRaceStore();
    ...
    if (raceStatus === 'running') {
      ...
      if (Object.keys(workersRef.current).length === 0) {
        algorithms.forEach(algo => {
          ...
          worker.postMessage({ type: 'INIT', payload: { algorithm: algo, array } });
  ...
  }, [raceStatus, speed, algorithms, array, soundEnabled]);
